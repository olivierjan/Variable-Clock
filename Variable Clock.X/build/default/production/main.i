...
# 15 "/Applications/microchip/xc8/v2.31/pic/include/c99/math.h" 3
# 1 "/Applications/microchip/xc8/v2.31/pic/include/c99/bits/alltypes.h" 1 3
...
void main(void)
{
    ...
    OLED_Init();
# 75 "main.c"
    const unsigned long long xtalfreq = 64000000/1000;
    __uint24 ncocounter=0;
    unsigned long long freqvalue = 0;
    _Bool automaticclock = 1 ;
    ...
    while (1)
    {
        ...
        if (PORTAbits.RA0 && PORTAbits.RA1) {
            ...
            if (RD1PPS){
                ...
                OLED_ClearDisplay();
                OLED_Write_Text(255,0,"Manual Mode");
        ...
        if (!automaticclock && (PORTAbits.RA1 || PORTAbits.RA0)){
            ...
            OLED_ClearDisplay();
            if (PORTDbits.RD1) {
                OLED_Write_Text(255,0,"HIGH");
            } else {
                OLED_Write_Text(255,0,"LOW");
            }
        ...
        if (PORTAbits.RA1 && (ncocounter > 0x8ff) && automaticclock) {



            savecounter(ncocounter -= 0x8ff);
        ...
        if (PORTAbits.RA0 && (ncocounter < (0x40000-0x8ff)) && automaticclock) {
...
void savecounter (__uint24 Counter) {
    ...
    NCO1CONbits.EN = 1;
    _delay((unsigned long)((32)*(64000000/4000.0)));
}
